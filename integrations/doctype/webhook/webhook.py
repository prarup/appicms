...
class Webhook(Document):
	...
	if TYPE_CHECKING:
		...
		webhook_docevent: DF.Literal["after_insert", "on_update", "on_submit", "on_cancel", "on_trash", "on_update_after_submit", "on_change"]
		webhook_doctype: DF.Link
		webhook_headers: DF.Table[WebhookHeader]
		webhook_hi: DF.Data | None
		webhook_json: DF.Code | None
		webhook_od: DF.Data | None
