...
class PermissionInspector(Document):
	...
	if TYPE_CHECKING:
		...
		output: DF.Code | None
		permission_inspector_hi: DF.Data | None
		permission_inspector_od: DF.Data | None
		permission_type: DF.Literal["read", "write", "create", "delete", "submit", "cancel", "select", "amend", "print", "email", "report", "import", "export", "share"]
		ref_doctype: DF.Link
		user: DF.Link
