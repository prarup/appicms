...
class ChildAttendance(Document):
	...
	if TYPE_CHECKING:
		from frappe.core.doctype.child_attendance_list.child_attendance_list import ChildAttendanceList
		...
		block_id: DF.Link
		breakfast: DF.Int
		child_attendance_hi: DF.Data | None
		child_attendance_od: DF.Data | None
