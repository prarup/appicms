...
class HouseholdForm(Document):
	...
	if TYPE_CHECKING:
		from frappe.core.doctype.household_child_form.household_child_form import HouseholdChildForm
		...
		household_form_hi: DF.Data | None
		household_form_od: DF.Data | None
		is_active: DF.Check
