...
class CrecheMonitoringChecklistCC(Document):
	...
	if TYPE_CHECKING:
		...
		clock: DF.Link | None
		cmc_cc_guid: DF.Data | None
		cms_uptodate: DF.Link | None
		containers: DF.Link | None
		creche_id: DF.Link
		creche_monitoring_checklist_cc_hi: DF.Data | None
		creche_monitoring_checklist_cc_od: DF.Data | None
