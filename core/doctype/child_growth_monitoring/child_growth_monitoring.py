...
class ChildGrowthMonitoring(Document):
	...
	if TYPE_CHECKING:
		from frappe.core.doctype.anthropromatic_data.anthropromatic_data import AnthropromaticData
		from frappe.types import DF

		anthropromatic_details: DF.Table[AnthropromaticData]
		block_id: DF.Link
		cgmguid: DF.Data | None
		child_growth_monitoring_hi: DF.Data | None
		child_growth_monitoring_od: DF.Data | None
