(() => {
      ...
      frappe.views.TreeView = class TreeView {
        ...
        make_page() {
          ...
          if (frappe.meta.has_field(me2.doctype, "disabled")) {
            ...
            this.page.inner_toolbar.addClass("flex align-center").on("click", "input[type='checkbox']", function() {
              me2.rebuild_tree();
            });
          }
        ...
        make_tree() {
          ...
          if ((_a = this.page) == null ? void 0 : _a.inner_toolbar) {
            this.args["include_disabled"] = this.page.inner_toolbar.find("input[type='checkbox']").prop("checked");
          }
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/listing.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/filters/edit_filter.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/html/print_template.html
...
`;
  ...
  frappe.views.BaseList = class BaseList {
    ...
    _add_field(fieldname, doctype) {
      ...
      let is_virtual = (_a = this.meta.fields.find((df) => df.fieldname == fieldname)) == null ? void 0 : _a.is_virtual;
    ...
    set_title() {
      var _a;
      this.page.set_title(this.page_title, null, true, "", (_a = this.meta) == null ? void 0 : _a.description);
    }
    setup_view_menu() {
      const icon_map = {
        Image: "image-view",
  ...
  frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    avoid_realtime_update() {
      var _a;
      if ((_a = this.filter_area) == null ? void 0 : _a.is_being_edited()) {
        return true;
      }
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar_stat.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_view_permission_restrictions.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/image_view_item_row.html
...
`;
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/photoswipe_dom.html
...
<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_board.html
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_column.html
  ...
  // frappe-html:/home/cmsvmuser/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_card.html
...
//# sourceMappingURL=list.bundle.KD2U7QEB.js.map
